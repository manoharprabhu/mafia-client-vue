...
<template>
  <Panel>
    <main>
      ...
      <div v-if="role === 'HEADHUNTER'">
        Your role is Headhunter. You have been assigned a target. If the villagers vote and kill
        your target during the day, you win
      </div>
    </main>
  </Panel>
  <br />
